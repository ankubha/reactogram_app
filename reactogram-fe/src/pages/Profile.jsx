        ...
        <div className='container shadow mt-5 p-4'>
            <div className='row'>
                <div className='col-md-6 d-flex flex-column'>
                    ...
                    <p className='ms-3 fs-5 '>UI/UX Designer <a href='#'>@{user.user.fullName}</a> | Follow <a href="#">@{user.user.fullName}</a></p>
                ...
                <div className='col-md-6 d-flex flex-column justify-content-between mt-3'>
                    ...
                    <div className='mx-auto mt-md-0 mt-4'>
                        <button className='custom-btn custom-btn-white me-md-3 mx-1 mt-5'>
            ...
            <div className='row mb-4'>
                {myallposts.map((post) => {
                    return (
                        <div className='col-md-4 col-sm-12 mb-md-4' key={post._id}>
                                ...
                                <div id="carouselExampleIndicators" className="carousel slide" data-bs-ride="true">
                                    ...
                                    <div className="carousel-inner">
                                        ...
                                        <div className="carousel-item">
                                            <img src="https://images.unsplash.com/photo-1664574653790-cee0e10a4242?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80" className="d-block w-100" alt="..." />
                                        </div>
                                        <div className="carousel-item">
                                            <img src="https://images.unsplash.com/photo-1670396118274-4f14fdd6323d?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwcm9maWxlLXBhZ2V8Mzh8fHxlbnwwfHx8fA%3D%3D&auto=format&fit=crop&w=500&q=60" className="d-block w-100" alt="..." />
                                        </div>
                                    </div>
                                ...
                                <div className="card-body px-2">
                                    <div className='row'>
                                        <div className='col-6 d-flex'>
                                            <img className='p-2 profile-pic-popup' alt='profile pic' src='https://images.unsplash.com/photo-1445543949571-ffc3e0e2f55e?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1169&q=80' />
                                            ...
                                            <div className="dropdown ms-5">
                                                <a className="btn" href="#" role="button" data-bs-toggle="dropdown">
                                                    <i className="fs-3 fa-solid fa-ellipsis"></i>
                                                </a>
                                    ...
                                    <div className='row mt-2'>
                                        <div className='col-12 ms-2'>
                                            <p>Lorem ipsum exercitation dolore deserunt esse id.Nisi magna magna non amet qui magna non dolore eu labore.</p>
                                        </div>
                                    </div>
                            ...
                            <div className='upload-box'>
                                <div className='dropZoneContainer'>
                                    ...
                                    <div className='dropZoneOverlay'>
                                        ...
                                        <i class="fa-solid fa-cloud-arrow-up mb-2 fs-1"></i><br />Upload Photo from Computer</div>
                                </div>
                            </div>
                        </div>
