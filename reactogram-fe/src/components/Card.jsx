                ...
                <div className="card-body px-2">
                    <div className='row'>
                        <div className='col-6 d-flex'>
                            <img className='p-2 profile-pic-post' alt='profile pic' src='https://images.unsplash.com/photo-1445543949571-ffc3e0e2f55e?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1169&q=80' />
                        ...
                        {props.postData.author._id == user.user._id ? <div className='col-6'>
                            <i onClick={() => props.deletePost(props.postData._id)} style={{ cursor: "pointer" }} className="float-end fs-4 p-2 mt-1 fa-solid fa-ellipsis-vertical"></i>
                        </div> : ""}
                    </div>
                    ...
                    <div className='row my-3'>
                        <div className='col-6 d-flex'>
                            <i onClick={() => likeDislikePost(props.postData._id, 'like')} style={{ cursor: "pointer" }} className="ps-3 fs-4 fa-regular fa-thumbs-up"></i>
                            <i onClick={() => likeDislikePost(props.postData._id, 'unlike')} style={{ cursor: "pointer" }} className="ps-3 fs-4 fa-regular fa-thumbs-down"></i>
                            <i onClick={() => setCommentBox(true)} style={{ cursor: "pointer" }} className="ps-3 fs-4 fa-regular fa-comment"></i>
